...
.method public a(Landroid/content/Context;Landroid/view/View;ZLandroid/os/Bundle;)Landroid/view/View;
    ...
    .line 62
    iget-object v0, p0, Lawfo;->a:Ljava/util/ArrayList;
    ...
    .line 70
    iget-object v2, p0, Lawfo;->a:Ljava/lang/ref/WeakReference;

    iput-object v2, v0, Lawbq;->a:Ljava/lang/ref/WeakReference;
    ...
    invoke-virtual {v0, v2}, Lawgk;->b(Ljava/lang/String;)V

    .line 78
    :goto_1
    invoke-virtual {v0}, Lawgk;->f()Ljava/lang/String;
    ...
    invoke-virtual {v0, v2}, Lawgk;->c(Ljava/lang/String;)V

    .line 82
    const/4 v2, 0x1

    invoke-virtual {v0, v2}, Lawgk;->a(Z)V
    ...
    invoke-virtual {v0, p1, v2, p4}, Lawgk;->a(Landroid/content/Context;Landroid/view/View;Landroid/os/Bundle;)Landroid/view/View;
    ...
    invoke-virtual {v0, v2}, Lawgk;->b(I)V
    ...
    .line 98
    iget-object v2, v0, Lawdt;->c:Ljava/lang/String;
    ...
    invoke-virtual {v0, p1, v2, v3, p4}, Lawdt;->a(Landroid/content/Context;Landroid/view/View;ZLandroid/os/Bundle;)Landroid/view/View;
    ...
    .line 135
    iget-object v3, p0, Lawfo;->a:Ljava/lang/ref/WeakReference;
    ...
    invoke-virtual {v0, v3}, Lawgk;->b(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v3}, Lawgk;->c(Ljava/lang/String;)V

    .line 147
    const/4 v3, 0x1

    invoke-virtual {v0, v3}, Lawgk;->a(Z)V

    .line 148
    const/4 v3, 0x0

    invoke-virtual {v0, p1, v3, p4}, Lawgk;->a(Landroid/content/Context;Landroid/view/View;Landroid/os/Bundle;)Landroid/view/View;
    ...
    invoke-virtual {v0, v3}, Lawgk;->b(I)V
    ...
    invoke-virtual {v0, p1, v3, v8, p4}, Lawdt;->a(Landroid/content/Context;Landroid/view/View;ZLandroid/os/Bundle;)Landroid/view/View;
    ...
    .line 184
    iget-object v9, v0, Lawdt;->c:Ljava/lang/String;
    ...
    .line 227
    :cond_11
    invoke-virtual {p0, v1}, Lawfo;->a(Landroid/view/View;)V
...
.method public b(Landroid/content/Context;Landroid/view/View;Landroid/os/Bundle;)Landroid/view/View;
    ...
    invoke-virtual {p0, p1, p2, v0, p3}, Lawfo;->a(Landroid/content/Context;Landroid/view/View;ZLandroid/os/Bundle;)Landroid/view/View;
