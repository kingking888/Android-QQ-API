...
.method public decompress([B)I
    ...
    .local v4, "size":I
    :try_start_0
    iget-wide v6, p0, Lcom/tencent/mobileqq/pic/JpegDecompressor;->nativePtr:J

    invoke-direct {p0, v6, v7, p1}, Lcom/tencent/mobileqq/pic/JpegDecompressor;->decompress(J[B)J
    :try_end_0
    .catch Ljava/lang/UnsatisfiedLinkError; {:try_start_0 .. :try_end_0} :catch_0
...
.method decompressRegion([BLandroid/graphics/Rect;)V
    ...
    .line 335
    invoke-direct/range {v1 .. v8}, Lcom/tencent/mobileqq/pic/JpegDecompressor;->decompressRegion(J[BIIII)J
    :try_end_0
    .catch Ljava/lang/UnsatisfiedLinkError; {:try_start_0 .. :try_end_0} :catch_0
...
.method decompressRegionBitmap(Landroid/graphics/Bitmap;Landroid/graphics/Rect;)I
    ...
    .line 350
    invoke-direct/range {v1 .. v8}, Lcom/tencent/mobileqq/pic/JpegDecompressor;->decompressRegionBitmap(JLandroid/graphics/Bitmap;IIII)J
    :try_end_0
    .catch Ljava/lang/UnsatisfiedLinkError; {:try_start_0 .. :try_end_0} :catch_0
...
.method decompressRegionHeader([BII)V
    ...
    invoke-direct/range {v1 .. v6}, Lcom/tencent/mobileqq/pic/JpegDecompressor;->decompressRegionHeader(J[BII)I
    :try_end_0
    .catch Ljava/lang/UnsatisfiedLinkError; {:try_start_0 .. :try_end_0} :catch_0
...
.method getBitmap(Landroid/graphics/Bitmap$Config;Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    invoke-direct {p0, v6, v7, v0}, Lcom/tencent/mobileqq/pic/JpegDecompressor;->decompressBitmap(JLandroid/graphics/Bitmap;)J
    :try_end_0
    .catch Ljava/lang/UnsatisfiedLinkError; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setParams(Z)V
    ...
    invoke-direct/range {v1 .. v6}, Lcom/tencent/mobileqq/pic/JpegDecompressor;->setParams(JZIZ)V
    :try_end_0
    .catch Ljava/lang/UnsatisfiedLinkError; {:try_start_0 .. :try_end_0} :catch_0
