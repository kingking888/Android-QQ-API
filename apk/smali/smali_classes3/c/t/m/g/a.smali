...
.method private static declared-synchronized b(Lc/t/m/g/b;)V
    ...
    .line 0
    invoke-static {v1}, Lc/t/m/g/ck;->a(Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 0
    invoke-static {v1, v3}, Lc/t/m/g/ck;->a(Landroid/content/Context;Ljava/lang/String;)I
    ...
    .line 0
    const-string v6, "com.tencent.halley.common.platform.service.PlatformService"

    invoke-static {v1, v5, v3, v6}, Lc/t/m/g/ck;->a(ILandroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Lc/t/m/g/ck$a;
    ...
    :cond_4
    iget-object v6, v5, Lc/t/m/g/ck$a;->d:Ljava/lang/String;

    if-eqz v6, :cond_5

    iget-object v6, v5, Lc/t/m/g/ck$a;->a:Ljava/lang/String;

    if-eqz v6, :cond_5

    iget-object v6, v5, Lc/t/m/g/ck$a;->d:Ljava/lang/String;

    iget-object v7, v5, Lc/t/m/g/ck$a;->a:Ljava/lang/String;
    ...
    :cond_5
    iget-boolean v0, v5, Lc/t/m/g/ck$a;->c:Z
    ...
    :cond_7
    iget-boolean v0, v5, Lc/t/m/g/ck$a;->b:Z
    ...
    .line 0
    const-string v5, "com.tencent.halley.common.platform.service.ActivateService"

    invoke-static {v1, v0, v3, v5}, Lc/t/m/g/ck;->a(ILandroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Lc/t/m/g/ck$a;

    move-result-object v0

    if-eqz v0, :cond_b

    iget-boolean v3, v0, Lc/t/m/g/ck$a;->c:Z
    ...
    :cond_9
    iget-object v3, v0, Lc/t/m/g/ck$a;->e:Landroid/os/Bundle;
    ...
    :cond_a
    iget-object v0, v0, Lc/t/m/g/ck$a;->e:Landroid/os/Bundle;

    const-string v3, "security_version"
    ...
    invoke-static {}, Lc/t/m/g/cf;->e()Lc/t/m/g/cf;

    move-result-object v1

    iput-object v1, v0, Lc/t/m/g/cg;->a:Lc/t/m/g/cd;

    :cond_c
    iget-object v1, v0, Lc/t/m/g/cg;->a:Lc/t/m/g/cd;

    invoke-interface {v1, v0}, Lc/t/m/g/cd;->a(Lc/t/m/g/bj;)V

    iget-object v0, v0, Lc/t/m/g/cg;->a:Lc/t/m/g/cd;
