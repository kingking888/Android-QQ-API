...
.method private a(LOnlinePushPack/MsgInfo;)V
    ...
    .line 65
    iget-wide v6, v0, LIMMsgBodyPack/PersonInfoField;->uField:J

    .line 70
    const-wide/16 v8, 0x4e2f

    cmp-long v0, v6, v8

    if-eqz v0, :cond_1

    const-wide/16 v8, 0x2719
    ...
    .line 72
    :cond_2
    const-wide/16 v8, 0x4e22

    cmp-long v0, v6, v8

    if-eqz v0, :cond_3

    const-wide/16 v8, 0x4e29

    cmp-long v0, v6, v8

    if-eqz v0, :cond_3

    const-wide/16 v8, 0x4e3f

    cmp-long v0, v6, v8

    if-eqz v0, :cond_3

    const-wide/16 v8, 0x4e33
    ...
    .line 79
    :cond_4
    iget-object v0, p0, Lakiy;->a:Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    .line 83
    iget-object v1, p0, Lakiy;->a:Lcom/tencent/mobileqq/app/QQAppInterface;
    ...
    new-instance v1, Lcom/tencent/mobileqq/app/message/ProfileCardMessageProcessor$1;

    invoke-direct {v1, p0}, Lcom/tencent/mobileqq/app/message/ProfileCardMessageProcessor$1;-><init>(Lakiy;)V
...
.method public a(ILOnlinePushPack/MsgInfo;LOnlinePushPack/SvcReqPushMsg;)Lakiv;
    ...
    .line 38
    invoke-direct {p0, p2}, Lakiy;->a(LOnlinePushPack/MsgInfo;)V
    ...
    invoke-virtual {p0, v0, p1}, Lakiy;->a(Ljava/lang/String;I)V
