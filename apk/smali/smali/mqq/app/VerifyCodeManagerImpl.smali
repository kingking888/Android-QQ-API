...
.method private notifyVerifyCodeActivity(Lcom/tencent/qphone/base/remote/ToServiceMsg;Ljava/lang/String;[BLjava/lang/String;)V
    ...
    iget-object v10, p0, Lmqq/app/VerifyCodeManagerImpl;->verifyCodeWrapperMap:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    check-cast v9, Lmqq/app/VerifyCodeManagerImpl$VerifyCodeWrapper;

    .line 268
    .local v9, "wrapper":Lmqq/app/VerifyCodeManagerImpl$VerifyCodeWrapper;
    iget-object v10, v9, Lmqq/app/VerifyCodeManagerImpl$VerifyCodeWrapper;->serverNotifyObserver:Lmqq/observer/ServerNotifyObserver;

    if-eqz v10, :cond_0

    .line 269
    iget-object v10, p0, Lmqq/app/VerifyCodeManagerImpl;->mHandler:Landroid/os/Handler;
    ...
    iget-object v12, v9, Lmqq/app/VerifyCodeManagerImpl$VerifyCodeWrapper;->serverNotifyObserver:Lmqq/observer/ServerNotifyObserver;
    ...
    .line 286
    const-string v10, "hide_operation_bar"
    ...
    .line 287
    const-string v10, "hide_more_button"
    ...
    const-string v10, "mqqverifycode://puzzle_verify_code/"
    ...
    :cond_1
    iget-object v10, p0, Lmqq/app/VerifyCodeManagerImpl;->app:Lmqq/app/AppRuntime;

    invoke-virtual {v10}, Lmqq/app/AppRuntime;->getApplication()Lmqq/app/MobileQQ;

    move-result-object v10

    invoke-virtual {v10, v4}, Lmqq/app/MobileQQ;->startActivity(Landroid/content/Intent;)V
    ...
    .line 293
    const-string v2, "mqq.opensdk.intent.action.VERIFYCODE"
    ...
    invoke-virtual {v4, v10, v0}, Landroid/content/Intent;->putExtra(Ljava/lang/String;[B)Landroid/content/Intent;
...
.method public refreVerifyCode(Lmqq/observer/ServerNotifyObserver;)V
    ...
    const-string/jumbo v7, "wrapper is null"
