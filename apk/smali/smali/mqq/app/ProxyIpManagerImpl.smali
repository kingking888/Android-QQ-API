...
.method public getProxyIp(I)Ljava/util/List;
    ...
    .line 58
    iget-object v4, p0, Lmqq/app/ProxyIpManagerImpl;->mApp:Lmqq/app/AppRuntime;

    invoke-virtual {v4}, Lmqq/app/AppRuntime;->getApplication()Lmqq/app/MobileQQ;

    move-result-object v4

    invoke-virtual {p0, v4}, Lmqq/app/ProxyIpManagerImpl;->isMobileNetWork(Landroid/content/Context;)Z
    ...
    .line 59
    const-string v4, "ProxyIpManagerImpl"

    new-instance v5, Ljava/lang/StringBuilder;

    invoke-direct {v5}, Ljava/lang/StringBuilder;-><init>()V

    const-string v6, "Load local proxy ip failed, uin:"
    ...
    const-string v6, " reason: not mobile network!"
    ...
    .line 62
    :cond_0
    iget-object v4, p0, Lmqq/app/ProxyIpManagerImpl;->mProxyIpCache:Ljava/util/ArrayList;
    ...
    check-cast v2, Lcom/tencent/msf/service/protocol/serverconfig/ProxyIpList;

    .line 64
    .local v2, "ipList":Lcom/tencent/msf/service/protocol/serverconfig/ProxyIpList;
    if-eqz v2, :cond_1

    iget-wide v6, v2, Lcom/tencent/msf/service/protocol/serverconfig/ProxyIpList;->uService_type:J
    ...
    .line 65
    iget-object v4, v2, Lcom/tencent/msf/service/protocol/serverconfig/ProxyIpList;->vIplist:Ljava/util/ArrayList;
    ...
    .line 67
    .local v3, "result":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lmqq/manager/ProxyIpManager$ProxyIp;>;"
    iget-object v4, v2, Lcom/tencent/msf/service/protocol/serverconfig/ProxyIpList;->vIplist:Ljava/util/ArrayList;
    ...
    check-cast v1, Lcom/tencent/msf/service/protocol/serverconfig/ProxyIpInfo;

    .line 68
    .local v1, "ipInfo":Lcom/tencent/msf/service/protocol/serverconfig/ProxyIpInfo;
    new-instance v0, Lmqq/manager/ProxyIpManager$ProxyIp;

    invoke-direct {v0}, Lmqq/manager/ProxyIpManager$ProxyIp;-><init>()V

    .line 69
    .local v0, "ip":Lmqq/manager/ProxyIpManager$ProxyIp;
    iget v5, v1, Lcom/tencent/msf/service/protocol/serverconfig/ProxyIpInfo;->uType:I

    iput v5, v0, Lmqq/manager/ProxyIpManager$ProxyIp;->type:I

    .line 70
    iget v5, v1, Lcom/tencent/msf/service/protocol/serverconfig/ProxyIpInfo;->uIp:I

    invoke-static {v5}, Lcom/tencent/qphone/base/util/StringUtils;->getIpAddrFromInt(I)Ljava/lang/String;

    move-result-object v5

    iput-object v5, v0, Lmqq/manager/ProxyIpManager$ProxyIp;->ip:Ljava/lang/String;

    .line 71
    iget v5, v1, Lcom/tencent/msf/service/protocol/serverconfig/ProxyIpInfo;->uPort:I

    iput v5, v0, Lmqq/manager/ProxyIpManager$ProxyIp;->port:I
    ...
    .line 74
    .end local v0    # "ip":Lmqq/manager/ProxyIpManager$ProxyIp;
    .end local v1    # "ipInfo":Lcom/tencent/msf/service/protocol/serverconfig/ProxyIpInfo;
    :cond_2
    const-string v4, "ProxyIpManagerImpl"
    ...
    const-string v6, "Load local proxy ip succ, uin: "
    ...
    .line 77
    .end local v3    # "result":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lmqq/manager/ProxyIpManager$ProxyIp;>;"
    :cond_3
    const-string v4, "ProxyIpManagerImpl"
    ...
    const-string v6, " reason: ip list is null!"
    ...
    .line 83
    .end local v2    # "ipList":Lcom/tencent/msf/service/protocol/serverconfig/ProxyIpList;
    :cond_4
    const-string v4, "ProxyIpManagerImpl"
    ...
    const-string v6, " reason: ip cache is null!"
...
.method public reloadCache(Ljava/lang/String;Z)V
    ...
    invoke-virtual {v6, v7, v8}, Lcom/tencent/msf/boot/config/NativeConfigStore;->loadConfig(Landroid/content/Context;Z)I
