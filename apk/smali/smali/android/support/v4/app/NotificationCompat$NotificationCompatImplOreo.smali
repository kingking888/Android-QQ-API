.class Landroid/support/v4/app/NotificationCompat$NotificationCompatImplOreo;
...
.annotation system Ldalvik/annotation/InnerClass;
    accessFlags = 0x8
    name = "NotificationCompatImplOreo"
.end annotation
...
.method public build(Landroid/support/v4/app/NotificationCompat$Builder;)Landroid/app/Notification;
    ...
    .prologue
    .line 155
    new-instance v1, Landroid/support/v4/app/NotificationCompatOreo;
    ...
    invoke-direct/range {v1 .. v18}, Landroid/support/v4/app/NotificationCompatOreo;-><init>(Landroid/content/Context;Landroid/app/Notification;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Landroid/widget/RemoteViews;ILandroid/app/PendingIntent;Landroid/app/PendingIntent;Landroid/graphics/Bitmap;IIZZILjava/lang/CharSequence;Ljava/lang/String;)V

    .line 160
    .local v1, "jbBuilder":Landroid/support/v4/app/NotificationCompatOreo;
    move-object/from16 v0, p1
    ...
    check-cast v19, Landroid/support/v4/app/NotificationCompat$Action;

    .line 161
    .local v19, "action":Landroid/support/v4/app/NotificationCompat$Action;
    ...
    iget-object v5, v0, Landroid/support/v4/app/NotificationCompat$Action;->actionIntent:Landroid/app/PendingIntent;

    invoke-virtual {v1, v3, v4, v5}, Landroid/support/v4/app/NotificationCompatOreo;->addAction(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)V

    goto :goto_0

    .line 163
    .end local v19    # "action":Landroid/support/v4/app/NotificationCompat$Action;
    :cond_0
    move-object/from16 v0, p1
    ...
    invoke-virtual {v1, v2, v3, v4, v5}, Landroid/support/v4/app/NotificationCompatOreo;->addBigTextStyle(Ljava/lang/CharSequence;ZLjava/lang/CharSequence;Ljava/lang/CharSequence;)V

    .line 186
    .end local v20    # "style":Landroid/support/v4/app/NotificationCompat$BigTextStyle;
    :cond_1
    :goto_1
    invoke-virtual {v1}, Landroid/support/v4/app/NotificationCompatOreo;->build()Landroid/app/Notification;
    ...
    invoke-virtual {v1, v2, v3, v4, v5}, Landroid/support/v4/app/NotificationCompatOreo;->addInboxStyle(Ljava/lang/CharSequence;ZLjava/lang/CharSequence;Ljava/util/ArrayList;)V
    ...
    invoke-virtual/range {v1 .. v7}, Landroid/support/v4/app/NotificationCompatOreo;->addBigPictureStyle(Ljava/lang/CharSequence;ZLjava/lang/CharSequence;Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;Z)V
