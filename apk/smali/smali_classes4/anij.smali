...
.method protected doApplyNextFrame()V
    ...
    .line 45
    iget-boolean v0, p0, Lanij;->c:Z

    if-eqz v0, :cond_0

    .line 46
    iput-boolean v1, p0, Lanij;->c:Z

    .line 47
    iput-boolean v1, p0, Lanij;->b:Z
...
.method public draw(Landroid/graphics/Canvas;Landroid/graphics/Rect;Landroid/graphics/Paint;Z)V
    ...
    .line 22
    invoke-virtual {p0}, Lanij;->initHandlerAndRunnable()V

    .line 23
    iget-boolean v0, p0, Lanij;->a:Z

    if-nez v0, :cond_1

    iget-object v0, p0, Lanij;->mFirstFrameBitmap:Landroid/graphics/Bitmap;
    ...
    .line 31
    :cond_2
    sget-boolean v0, Lanij;->sPaused:Z

    if-nez v0, :cond_3

    .line 32
    invoke-virtual {p0}, Lanij;->executeNewTask()V

    goto :goto_0

    .line 33
    :cond_3
    iget-boolean v0, p0, Lanij;->mIsInPendingAction:Z

    if-nez v0, :cond_0

    .line 34
    sget-object v0, Lanij;->sPendingActions:Ljava/util/ArrayList;
    ...
    iput-boolean v0, p0, Lanij;->mIsInPendingAction:Z
