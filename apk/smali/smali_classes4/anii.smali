...
.method protected doApplyNextFrame()V
    ...
    .line 79
    iget-boolean v0, p0, Lanii;->c:Z

    if-eqz v0, :cond_1

    .line 80
    iput-boolean v3, p0, Lanii;->c:Z

    .line 81
    iput-boolean v3, p0, Lanii;->b:Z
...
.method public draw(Landroid/graphics/Canvas;Landroid/graphics/Rect;Landroid/graphics/Paint;Z)V
    ...
    .line 26
    invoke-virtual {p0}, Lanii;->initHandlerAndRunnable()V

    .line 27
    iget-boolean v0, p0, Lanii;->a:Z

    if-nez v0, :cond_2

    iget-object v0, p0, Lanii;->mFirstFrameBitmap:Landroid/graphics/Bitmap;
    ...
    :cond_3
    :goto_1
    sget-boolean v0, Lanii;->sPaused:Z

    if-nez v0, :cond_5

    .line 50
    invoke-virtual {p0}, Lanii;->executeNewTask()V
    ...
    .line 55
    :cond_5
    iget-boolean v0, p0, Lanii;->mIsInPendingAction:Z

    if-nez v0, :cond_0

    .line 56
    sget-object v0, Lanii;->sPendingActions:Ljava/util/ArrayList;
    ...
    iput-boolean v0, p0, Lanii;->mIsInPendingAction:Z
