...
# direct methods
.method constructor <init>(Lthp;Ljava/lang/String;)V
    .locals 0

    .prologue
    .line 747
    iput-object p1, p0, Lthv;->a:Lthp;
...
.method protected varargs a(Lcom/tribe/async/async/JobContext;[Ljava/lang/Void;)Ljava/lang/Object;
    ...
    invoke-direct {v3, v0}, Ltji;-><init>(Lcom/tencent/biz/qqstory/model/item/StoryVideoItem;)V
    ...
    .line 760
    :cond_0
    iget-object v0, p0, Lthv;->a:Lthp;

    invoke-virtual {v0, v1}, Lthp;->a(Ljava/util/List;)V
    ...
    const-string v3, "had load local task size "
...
.method protected synthetic doInBackground(Lcom/tribe/async/async/JobContext;[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Lthv;->a(Lcom/tribe/async/async/JobContext;[Ljava/lang/Void;)Ljava/lang/Object;
