...
.method public a()V
    ...
    .line 111
    iput-object v2, p0, Loak;->a:Loan;

    .line 112
    iget-object v0, p0, Loak;->a:Ljava/util/ArrayList;

    if-eqz v0, :cond_0

    .line 113
    iget-object v1, p0, Loak;->a:Ljava/util/ArrayList;
    ...
    .line 116
    iput-object v2, p0, Loak;->a:Ljava/util/ArrayList;
...
.method public a(Landroid/content/Intent;Lcom/tencent/qphone/base/remote/FromServiceMsg;)V
    ...
    iput-object v1, p0, Loak;->a:Ljava/util/ArrayList;
    ...
    .line 198
    iget-object v5, p0, Loak;->a:Ljava/util/ArrayList;
    ...
    iget-wide v8, v1, Loam;->a:J

    iget-wide v10, v0, LOnlinePushPack/SvcReqPushMsg;->lUin:J
    ...
    .line 209
    :goto_2
    iget-object v2, p0, Loak;->a:Ljava/util/ArrayList;
    ...
    invoke-direct {v1, p0, v3}, Loam;-><init>(Loak;Loal;)V

    .line 219
    iput v4, v1, Loam;->a:I

    .line 220
    iget-wide v6, v0, LOnlinePushPack/SvcReqPushMsg;->lUin:J

    iput-wide v6, v1, Loam;->a:J

    .line 221
    iget-object v3, p0, Loak;->a:Ljava/util/ArrayList;
    ...
    .line 244
    iget-wide v6, v1, LOnlinePushPack/MsgInfo;->lFromUin:J

    iput-wide v6, v4, LOnlinePushPack/DelMsgInfo;->lFromUin:J
    ...
    .line 246
    iget-wide v6, v1, LOnlinePushPack/MsgInfo;->uMsgTime:J

    iput-wide v6, v4, LOnlinePushPack/DelMsgInfo;->uMsgTime:J
    ...
    .line 262
    iget-object v4, p0, Loak;->a:Loan;

    invoke-interface {v4, v1, v5}, Loan;->a(ILjava/lang/String;)V
    :try_end_5
    ...
    invoke-interface {v0, v3, v1}, Loan;->a(ILOnlinePushPack/SvcRespPushMsg;)V
...
.method public a(Ljava/lang/String;Ljava/lang/String;Lmqq/app/AppRuntime;Landroid/content/Context;Loan;)V
    .locals 2
    ...
    .line 83
    iput-object p4, p0, Loak;->a:Landroid/content/Context;

    .line 84
    iput-object p5, p0, Loak;->a:Loan;
    ...
    .line 90
    :cond_0
    invoke-virtual {p0, p3}, Loak;->a(Lmqq/app/AppRuntime;)V
